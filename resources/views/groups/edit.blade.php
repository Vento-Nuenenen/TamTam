...
@section('content')
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::open(array('route' => ['update-groups',$group->id], 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'enctype' => "multipart/form-data")) !!}
                {!! csrf_field() !!}
                ...
                <div class="form-group has-feedback row {{ $errors->has('group_name') ? ' has-error ' : '' }}">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            {!! Form::text('group_name', old('group_name', $group->name ?? null), array('id' => 'group_name', 'class' => 'form-control', 'placeholder' => 'Gruppenname', 'required')) !!}
